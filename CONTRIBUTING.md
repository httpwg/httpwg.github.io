...
Before doing so, it's a good idea to familiarize yourself with our [charter](https://datatracker.ietf.org/wg/httpbis/about/) and [home page](https://httpwg.org/). If you're new to the [IETF](https://www.ietf.org/), you may also want to read [Getting Started the IETF](https://www.ietf.org/participate/get-started/) and [an informal guide to the IETF process](https://www.ietf.org/process/informal/).
